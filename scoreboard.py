...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        score_str = self.format_score(self.stats.score)
    ...
    def prep_high_score(self):
        ...
        high_score_str = self.format_score(self.stats.high_score)
    ...
    def check_high_score(self):
        """Update high score if it is above the score"""
