...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        # Creaet the full fleet of aliens
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and not self.game_stats.game_active:
